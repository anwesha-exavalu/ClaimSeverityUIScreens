...
const FeatureInputFormMedical = ({ setActiveTab, setPredictionData }) => {
  ...
  const setHardcodedFormData = () => {
    try {
      ...
      const hardcodedData = {
        ...
        "First ICD Diagnosis Code": "Enthesopathies-M77.8",
        "Second ICD Diagnosis Code": "Edema-R60.9",
        "Third ICD Diagnosis Code": "R29.3",
        "Principal Diagnosis Code": "Shoulder lesion-M75.91",
        "Admitting Diagnosis Code": "Shoulder lesion-M75.91",
        "policy_start_date": moment("01-26-2018"),
        "First ICD Procedure Code": "Reposition Left Internal Fixation-0PSJ04Z",
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      // Make API call
      const response = await fetch('http://204.236.254.168:5000/predict', {
        method: 'POST',
        headers: {
